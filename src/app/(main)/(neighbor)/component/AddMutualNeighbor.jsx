    ...
    <div className="neighbor-content">
        ...
        <div className="set-buddy-top" style={{paddingTop: "10px"}}>
            ...
            <div className="set-input" style={{borderLeft: "50px"}}>
                ...
                <label htmlFor="r1" style={{paddingLeft: "8px"}}>사용</label>
                <input name="allowMutualBuddy" className="bothBuddyDenied" type="radio" id="r2"/>
                <label htmlFor="r2" style={{paddingLeft: "8px"}}>사용하지 않음</label>
            </div>
        </div>
        ...
        <div className="neighbor-requests">
            <div className="tab-menu">
                <button className={activeTab ==='received'?"active":""} onClick={()=>setActiveTab('received')}>받은신청</button>
                <button className={activeTab ==='sent'?"active":""} onClick={()=>setActiveTab('sent')}>보낸신청</button>
                <button>안내메시지</button>
            </div>
            {activeTab === 'received' &&(<div>
